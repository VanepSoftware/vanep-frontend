    ...
    <span className={`inline-flex items-center ${className}`}>
      {withTrail && (
        <span aria-hidden className="mr-2 flex items-end gap-[3px] self-center">
          <span className="animate-pixel block h-1.5 w-1.5 rounded-[1px] bg-accent/40 [animation-delay:0ms]" />
          <span className="animate-pixel block h-2 w-2 rounded-[1px] bg-accent/60 [animation-delay:150ms]" />
          <span className="animate-pixel block h-2.5 w-2.5 rounded-[2px] bg-accent/80 [animation-delay:300ms]" />
        </span>
      )}
